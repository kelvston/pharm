/**
 * Created by gwanchi on 4/5/17.
 */

/*! CloudFlareJS-0.1.8 Fri Oct 25 2013 14:25:03
 */
! function (a, b) {
    function c(a) {
    ...
    var m = function () {
            ...
            return function (d) {
                ...
                function g(a) {
                    a.length = 0, B.length < E && B.push(a)
                }

                function h(a) {
                    var b = a.k;
                    b && h(b), a.b = a.k = a.object = a.number = a.string = null, C.length < E && C.push(a)
                }
                ...
                function l(a, b, c) {
                    function d() {
                        var i = arguments,
                            j = f ? this : b;
                        return e || (a = b[g]), c.length && (i = i.length ? (i = gb.call(i), h ? i.concat(c) : c.concat(i)) : c), this instanceof d ? (j = n(a.prototype), i = a.apply(j, i), s(i) ? i : j) : a.apply(j, i)
                    }
                    var e = r(a),
                        f = !c,
                        g = b;
                ...
                function m() {
                    ...
                    a.g = H, a.b = a.c = a.f = a.h = "", a.e = "r", a.i = !0, a.j = !! ob;
                    for (var b, c = 0; b = arguments[c]; c++)
                        for (var d in b) a[d] = b[d];
                    c = a.a, a.d = /^[^,]+/.exec(c)[0], b = Function, c = "return function(" + c + "){", d = "var m,r=" + a.d + ",C=" + a.e + ";if(!r)return C;" + a.h + ";", a.b ? (d += "var s=r.length;m=-1;if(" + a.b + "){", kb.unindexedChars && (d += "if(q(r)){r=r.split('')}"), d += "while(++m<s){" + a.f + ";}}else{") : kb.nonEnumArgs && (d += "var s=r.length;m=-1;if(s&&n(r)){while(++m<s){m+='';" + a.f + ";}}else{"), kb.enumPrototypes && (d += "var E=typeof r=='function';"), kb.enumErrorProps && (d += "var D=r===j||r instanceof Error;");
                    var e = [];
                    if (kb.enumPrototypes && e.push('!(E&&m=="prototype")'), kb.enumErrorProps && e.push('!(D&&(m=="message"||m=="name"))'), a.i && a.j) d += "var A=-1,B=z[typeof r]&&t(r),s=B?B.length:0;while(++A<s){m=B[A];", e.length && (d += "if(" + e.join("&&") + "){"), d += a.f + ";", e.length && (d += "}"), d += "}";
                    else if (d += "for(m in r){", a.i && e.push("l.call(r, m)"), e.length && (d += "if(" + e.join("&&") + "){"), d += a.f + ";", e.length && (d += "}"), d += "}", kb.nonEnumShadows) {
                    ...
                    return (a.b || kb.nonEnumArgs) && (d += "}"), d += a.c + ";return C", b = b("i,j,l,n,o,q,t,u,y,z,w,G,H,J", c + d + "}"), h(a), b(M, W, $, o, mb, t, ob, j, X, S, jb, Q, Y, ab)
                }
                ...
                function p(a, b, c, d, f, h) {
                    var k = a;
                    if ("boolean" != typeof b && null != b && (d = c, c = b, b = !1), "function" == typeof c) {
                        if (c = "undefined" == typeof d ? c : j.createCallback(c, d, 1), k = c(k), "undefined" != typeof k) return k;
                        k = a
                    }
                    if (d = s(k)) {
                        var l = ab.call(k);
                        if (!R[l] || !kb.nodeClass && e(k)) return k;
                        var m = mb(k)
                    }
                    if (!d || !b) return d ? m ? i(k) : qb({}, k) : k;
                    switch (d = ib[l], l) {
                        case K:
                        case L:
                            return new d(+k);
                        ...
                        case Q:
                            return new d(k);
                        case P:
                            return d(k.source, F.exec(k))
                    }
                    l = !f, f || (f = B.pop() || []), h || (h = B.pop() || []);
                    for (var n = f.length; n--;)
                        if (f[n] == a) return h[n];
                    return k = m ? d(k.length) : {}, m && ($.call(a, "index") && (k.index = a.index), $.call(a, "input") && (k.input = a.input)), f.push(a), h.push(k), (m ? pb : sb)(a, function (a, d) {
                        k[d] = p(a, b, c, A, f, h)
                    }), l && (g(f), g(h)), k
                }

                function q(a, b, c, d, f, h) {
                    var i = c === D;
                    if ("function" == typeof c && !i) {
                        c = j.createCallback(c, d, 2);
                        var k = c(a, b);
                    ...
                    if (m = ab.call(a), l = ab.call(b), m == I && (m = O), l == I && (l = O), m != l) return !1;
                    switch (m) {
                        case K:
                        case L:
                            return +a == +b;
                    ...
                    if (l = m == J, !l) {
                        if ($.call(a, "__wrapped__") || $.call(b, "__wrapped__")) return q(a.__wrapped__ || a, b.__wrapped__ || b, c, d, f, h);
                        if (m != O || !kb.nodeClass && (e(a) || e(b))) return !1;
                        var m = !kb.argsObject && o(a) ? Object : a.constructor,
                            n = !kb.argsObject && o(b) ? Object : b.constructor;
                        if (m != n && !(r(m) && m instanceof m && r(n) && n instanceof n)) return !1
                    }
                    for (n = !f, f || (f = B.pop() || []), h || (h = B.pop() || []), m = f.length; m--;)
                        if (f[m] == a) return h[m] == b;
                    var p = 0,
                        k = !0;
                    if (f.push(a), h.push(b), l) {
                        if (m = a.length, p = b.length, k = p == a.length, !k && !i) return k;
                        for (; p--;)
                            if (l = m, n = b[p], i)
                                for (; l-- && !(k = q(a[l], n, c, d, f, h)););
                            else if (!(k = q(a[p], n, c, d, f, h))) break;
                        return k
                    }
                    return rb(b, function (b, e, g) {
                        return $.call(g, e) ? (p++, k = $.call(a, e) && q(a[e], b, c, d, f, h)) : void 0
                    }), k && !i && rb(a, function (a, b, c) {
                        return $.call(c, b) ? k = -1 < --p : void 0
                    }), n && (g(f), g(h)), k
                }
                ...
                function t(a) {
                    return "string" == typeof a || ab.call(a) == Q
                }

                function u(a) {
                    for (var b = -1, c = ob(a), d = c.length, e = Array(d); ++b < d;) e[b] = a[c[b]];
                    return e
                }

                function v(a, b, c) {
                    var d = [];
                    if (b = j.createCallback(b, c), mb(a)) {
                        c = -1;
                ...
                function y(a, b, c, d) {
                    var e = 0,
                        f = a ? a.length : e;
                    for (c = c ? j.createCallback(c, d, 1) : z, b = c(b); f > e;) d = e + f >>> 1, c(a[d]) < b ? e = d + 1 : f = d;
                    return e
                }
                ...
                var S = {
                    ...
                    U = S[typeof a] && a && a.exports == T && a,
                    V = S[typeof global] && global;
                !V || V.global !== V && V.window !== V || (d = V);
                var W = Error.prototype,
                    X = Object.prototype,
                    Y = String.prototype,
                    V = RegExp("^" + String(X.valueOf).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$"),
                    Z = Function.prototype.toString,
                    $ = X.hasOwnProperty,
                    _ = X.propertyIsEnumerable,
                    ab = X.toString,
                    bb = V.test(bb = ab.bind) && bb,
                    cb = V.test(cb = Object.create) && cb,
                    db = V.test(db = Array.isArray) && db,
                    eb = V.test(eb = Object.keys) && eb,
                    fb = Math.max,
                    gb = [].slice;
                d = V.test(d.attachEvent);
                var hb = bb && !/\n|true/.test(bb + d),
                    ib = {};
                ib[J] = Array, ib[K] = Boolean, ib[L] = Date, ib["[object Function]"] = Function, ib[O] = Object, ib[N] = Number, ib[P] = RegExp, ib[Q] = String;
                var jb = {};
                jb[J] = jb[L] = jb[N] = {
                    constructor: !0,
                    toLocaleString: !0,
                    ...
                    function () {
                        for (var a = H.length; a--;) {
                            var b, c = H[a];
                            for (b in jb) $.call(jb, b) && !$.call(jb[b], c) && (jb[b][c] = !1)
                        }
                    }();
                var kb = j.support = {};
                ! function () {
                    ...
                    for (d in arguments);
                    kb.argsObject = arguments.constructor == Object && !(arguments instanceof Array), kb.argsClass = o(arguments), kb.enumErrorProps = _.call(W, "message") || _.call(W, "name"), kb.enumPrototypes = _.call(a, "prototype"), kb.fastBind = bb && !hb, kb.nonEnumArgs = 0 != d, kb.nonEnumShadows = !/valueOf/.test(c), kb.unindexedChars = "xx" != "x" [0] + Object("x")[0];
                    try {
                        kb.nodeClass = !(ab.call(b) == O && !({
                            toString: 0
                        } + ""))
                    } catch (e) {
                        kb.nodeClass = !0
                ...
                cb || (n = function (a) {
                    ...
                    return b || {}
                }), kb.argsClass || (o = function (a) {
                    return a ? $.call(a, "callee") : !1
                });
                var mb = db || function (a) {
                            return a ? "object" == typeof a && ab.call(a) == J : !1
                        }, nb = m({
                        a: "x",
                        e: "[]",
                    ...
                    ob = eb ? function (a) {
                            return s(a) ? kb.enumPrototypes && "function" == typeof a || kb.nonEnumArgs && a.length && o(a) ? nb(a) : eb(a) : []
                        } : nb,
                    pb = m(V),
                    qb = m(d, {
                        h: d.h.replace(";", ";if(c>3&&typeof a[c-2]=='function'){var d=u.createCallback(a[--c-1],a[c--],2)}else if(c>2&&typeof a[c-1]=='function'){d=a[--c]}"),
                    ...
                    sb = m(V, lb);
                r(/x/) && (r = function (a) {
                    return "function" == typeof a && "[object Function]" == ab.call(a)
                }), j.assign = qb, j.bind = function (a, b) {
                    return kb.fastBind || bb && 2 < arguments.length ? bb.call.apply(bb, arguments) : l(a, b, gb.call(arguments, 2))
                }, j.createCallback = function (a, b, c) {
                    if (null == a) return z;
                    var d = typeof a;
                    if ("function" != d) {
                        ...
                        var e = ob(a);
                        return function (b) {
                            for (var c = e.length, d = !1; c-- && (d = q(b[e[c]], a[e[c]], D)););
                            return d
                        }
                    }
                    return "undefined" == typeof b || G && !G.test(Z.call(a)) ? a : 1 === c ? function (c) {
                                return a.call(b, c)
                            } : 2 === c ? function (c, d) {
                                    return a.call(b, c, d)
                ...
                }, j.filter = v, j.forEach = w, j.forIn = rb, j.forOwn = sb, j.keys = ob, j.map = x, j.toArray = function (a) {
                    return a && "number" == typeof a.length ? kb.unindexedChars && t(a) ? a.split("") : i(a) : u(a)
                }, j.values = u, j.collect = x, j.each = w, j.extend = qb, j.select = v, j.clone = p, j.findKey = function (a, b, c) {
                    var d;
                    return b = j.createCallback(b, c), sb(a, function (a, c, e) {
                        return b(a, c, e) ? (d = c, !1) : void 0
                    }), d
                }, j.identity = z, j.indexOf = function (a, b, c) {
                    if ("number" == typeof c) {
                        var d = a ? a.length : 0;
                        c = 0 > c ? fb(0, d + c) : c || 0
                    } else if (c) return c = y(a, b), a[c] === b ? c : -1;
                    if (a) a: {
                    ...
                    return a
                }, j.isArguments = o, j.isArray = mb, j.isElement = function (a) {
                    return a ? 1 === a.nodeType : !1
                }, j.isEqual = q, j.isFunction = r, j.isObject = s, j.isString = t, j.sortedIndex = y, j.VERSION = "1.3.1", T && !T.nodeType && U && ((U.exports = j)._ = j)
            }(this), a.exports
        }(),
        n = function (a, b, c, d) {
    ...
    ! function () {
        var c = {}, g = a.CloudFlare || {}, h = {}, k = [],
            ...
            q = function (a) {
                ...
                !w(a) && k.length && (F('Assigning anonymously defined module to "' + a + '"'), h[a] = k.pop()), k = []
            }, s = function (a) {
                var b = T(),
                    c = t(a);
                return w(a) ? b.resolve(h[a].promise) : c ? (F('Warning: "' + a + '" does not appear to define a module.'), h[a] = b, b.resolve()) : b.reject(new Error('Module "' + a + '" was not properly defined.')), b.promise
            }, t = function (a) {
                return !(a.split("/")[0] in d.paths)
            }, u = function (a) {
                return w(a) && !(U(h[a]) || V(h[a]))
            }, w = function (a) {
                return a in h && !U(h[a])
            }, x = function (a) {
                var d = "string" == typeof a && a,
                    e = function () {
                        ...
                        d && (a = b.getElementById(d)), "readyState" in a && "loaded" !== a.readyState && "complete" !== a.readyState || (eb || r(qb(a, "module")), e(), i.resolve())
                    }, h = function () {
                ...
                return function (b) {
                    var g = T(),
                        i = !1;
                    return w(b) ? g.resolve(h[b].promise) : (n(a, function (a) {
                            i = a == b
                                ...
                                e = 0, a = [], n(b, function (a) {
                                    var b, e = l(a);
                                    u(a) || (b = vb("script"), x(b).then(function () {
                                        n(c[a], function (b) {
                                            b.resolve(s(a))
                                        })
                                    }, function (b) {
            ...
            z = function (a) {
                var b, c = T();
                return w(a) ? c.resolve(h[a].promise) : (F('Writing "' + a + '" into the DOM as a blocking module.'), b = "cfjs_block_" + Mb(), x(b).then(function () {
                        c.resolve(s(a))
                    }, function (b) {
                ...
                return function (e) {
                    var g = T();
                    return w(e) ? g.resolve(h[e].promise) : (a.push(e), b[e] = b[e] || [], b[e].push(g), F('Queueing "' + e + '" to be resolved by the cloud.'), c = c || f(function () {
                                var e = {}, f = m.clone(a);
                                c = 0, a = [], F('The following queued modules are being looked up: "' + a.join('", "') + '."'), n(f, function (a) {
                                    var c = l(a);
                                    u(a) || (e[c] = e[c] || function (c, e) {
                                            if (e = i(e), c) {
                                                F('Executing code related to "' + a + '" that was received from the cloud.');
                                                try {
                                                    d.verbose && (c += "\n/*\n//# sourceURL=/cloudflarejs/module[" + a + "]\n*/"), Ob(c), r(a), n(b[a], function (b) {
                                                        b.resolve(s(a))
                                                    })
                                                } catch (f) {
                                                    n(b[a], function (a) {
            ...
            B = function (a, b) {
                ...
                var a = arguments.length,
                    ...
                    f = T();
                return w(b) ? f.reject(new Error('Module "' + name + '" is already defined.')) : e ? (eb && !b && (b = qb(o(), "module")), b ? h[b] = f : q(f), E(c, function () {
                ...
                return P = !0, result = B(a, z).then(function (a) {
        ...
        g && g.length && n(g, H), d.apps || d.bag || (d.bag = 0);
        try {
        ...
        }), h.exports = T(), h.exports.resolve(), h.module = T(), h.module.resolve(), c.require = E, c.require.paths = d.paths, c.define = C, c.define.amd = {}, c.block = D, c.push = H, c.version = e + "", tb(a, "load", function () {
            c.block = c.require
